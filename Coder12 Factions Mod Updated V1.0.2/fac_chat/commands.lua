...
factions.register_command("claim safezone", {
	global_privileges = {"faction_admin"},
	infaction = false,
	description = "Claim the current parcel as a safezone.",
	description_arg = ":",
	on_success = function(player, faction, pos, parcelpos, args)
		if factions.is_safezone(parcelpos) then
			minetest.chat_send_player(player, "This parcel is already a safezone.")
			return false
		end

		if factions.get_parcel_faction(parcelpos) then
			minetest.chat_send_player(player, "This parcel is already claimed.")
			return false
		end

		if factions.claim_safezone(parcelpos) then
			minetest.chat_send_player(player, "Safezone claimed at " .. parcelpos .. ".")
			return true
		end
...
factions.register_command("unclaim safezone", {
	global_privileges = {"faction_admin"},
	infaction = false,
	description = "Unclaim the current parcel as a safezone.",
	description_arg = ":",
	on_success = function(player, faction, pos, parcelpos, args)
		if not factions.is_safezone(parcelpos) then
			minetest.chat_send_player(player, "This parcel is not a safezone.")
			return false
		end

		factions.parcels.remove(parcelpos)

		minetest.chat_send_player(player, "Safezone unclaimed at " .. parcelpos .. ".")
		return true
	end
})
factions.register_command("claim warzone", {
	global_privileges = {"faction_admin"},
	infaction = false,
	description = "Claim the current parcel as a warzone.",
	description_arg = ":",
	on_success = function(player, faction, pos, parcelpos, args)
		if factions.is_warzone(parcelpos) then
			minetest.chat_send_player(player, "This parcel is already a warzone.")
			return false
		end
		...
		if factions.claim_warzone(parcelpos) then
			minetest.chat_send_player(player, "Warzone claimed at " .. parcelpos .. ".")
			return true
		end
...
factions.register_command("unclaim warzone", {
	global_privileges = {"faction_admin"},
	infaction = false,
	description = "Unclaim the current parcel as a warzone.",
	description_arg = ":",
	on_success = function(player, faction, pos, parcelpos, args)
		if not factions.is_warzone(parcelpos) then
			minetest.chat_send_player(player, "This parcel is not a warzone.")
			return false
		end

		factions.parcels.remove(parcelpos)

		minetest.chat_send_player(player, "Warzone unclaimed at " .. parcelpos .. ".")
		return true
	end
})
...
factions.register_command("create", {
    ...
    on_success = function(player, faction, pos, parcelpos, args)
        ...
        -- Prevent creation of Safezone/Warzone in any capitalization
        if string.lower(factionname) == "safezone" or string.lower(factionname) == "warzone" then
            minetest.chat_send_player(player, "That faction name is reserved.")
            return false
        end
...
factions.register_command("home", {
    description = "Teleport to your faction home",
    description_arg = ":",
    faction_permissions = {},
    global_privileges = def_global_privileges,
    ...
    on_success = function(player, faction, pos, parcelpos, args)
        ...
        if not faction.spawn then
            minetest.chat_send_player(player, "Your faction has not set a home.")
            return false
        end
